...
<form:form commandName="comintent" method="post" id="comintentsF" name="comintentsF">
...
<div class="row">
 ...
 <input type="text" disabled="disabled" value="${comintent.password}" style="width:40px" >
</div>
<hr>
<br>
...
<div class="form-group">
    ...
    <form:input path="activityOfCompany" class="form-control" id="activity" placeholder="Delatnost preduzeca"/>
