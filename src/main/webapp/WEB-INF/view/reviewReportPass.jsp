...
<table class="table table-condensed">
  ...
  <tbody>
      ...
      <input type="hidden" value="${reportComintents.id_report}" />
     <tr class="info">
      ...
      <td><c:out value="${reportComintents.dateAndTime}"></c:out></td>
        ...
        <td><div class="form-group">
		<button type="submit" class="btn btn-info btn-sm" id="print" name="print" value="Stampaj" target="_blank" ><span class="glyphicon glyphicon-print" aria-hidden="true">Stampaj</span></button>
		</div>
		</td>
		</tr>
		</c:forEach>
